// src/app/rent/ethnic/page.tsx

import Link from 'next/link';

// This is the CSS for our new product listing page.
const styles = `
...
const mockProducts = [
  {
    id: 1,
    name: 'Midnight Blue Sari',
    description: 'Velvet details, elegant fit',
    price: "xxx",
    imageUrl: 'https://static.vecteezy.com/system/resources/previews/007/718/689/non_2x/an-indian-woman-wearing-a-traditional-beautiful-saree-illustration-vector.jpg',
  }
];

export default function EthnicProductsPage() {
  return (
    <>
      {/* We inject the full CSS again to make this page self-contained */}
      <style>{`
        ${styles}
      ...
      <main className="main-content">
        <div className="products-container">
          <div className="page-header">
            <h1 className="page-title">Ethnic Wear</h1>
            <p className="page-subtitle">Timeless elegance for your special occasions.</p>
          </div>
          <div className="products-grid">
            {mockProducts.map((product) => (
              <Link key={product.id} href={`/rent/ethnic/${product.id}`} className="product-card">
