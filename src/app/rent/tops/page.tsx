...
const mockProducts = [
  {
    id: 5,
    name: 'Funky Green Top',
    description: 'Silk, floor-length',
    price: "xxx",
    imageUrl: 'https://plus.unsplash.com/premium_vector-1711922642968-168e8d4966d3?q=80&w=580&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  }
];
      ...
      <main className="main-content">
        <div className="products-container">
          <div className="page-header">
            ...
            <h1 className="page-title">Tops & Bottoms</h1>
